...
enum TaskCategories {
  ...
  fitness(Icons.fitness_center, Colors.lightGreen),
  entertainment(Icons.movie, Colors.red),
  finance(Icons.attach_money, Colors.teal),
  reading(Icons.book, Colors.cyan),
  volunteer(Icons.volunteer_activism, Colors.lime);
